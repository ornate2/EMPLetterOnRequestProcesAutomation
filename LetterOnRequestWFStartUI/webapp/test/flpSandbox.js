		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comaplLetterOnRequestWFStartUI-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comaplLetterOnRequestWFStartUI-display": {
								"semanticObject": "comaplLetterOnRequestWFStartUI",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.apl.LetterOnRequestWFStartUI",
									"url": sap.ui.require.toUrl("com/apl/LetterOnRequestWFStartUI")
								}
							}
						}
					}
